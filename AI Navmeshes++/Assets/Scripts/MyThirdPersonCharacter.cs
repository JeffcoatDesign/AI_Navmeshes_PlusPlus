...
namespace UnityStandardAssets.Characters.ThirdPerson
{
	...
	public class MyThirdPersonCharacter : MonoBehaviour
	{
        ...
        public void Move(Vector3 move, bool crouch, bool jump)
		{
			...
			if (m_Animator.GetCurrentAnimatorClipInfo(0)[0].clip.name == "Attack")
			{
				m_ForwardAmount = 0;
			}
		...
		public void HandleAttack (bool inRange)
		{
			bool cooled = Time.time - lastAttackTime > m_attackCooldown;
			if (cooled && inRange && m_Animator.GetCurrentAnimatorClipInfo(0)[0].clip.name != "Attack") {
